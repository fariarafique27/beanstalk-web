                        ...
                        <td class="pe-4 text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3 fs-7">
                                    <li><a class="dropdown-item d-flex align-items-center gap-2" href="#"><i class="ti ti-edit text-primary"></i> Edit Details</a></li>
                                    <li><a class="dropdown-item d-flex align-items-center gap-2" href="#"><i class="ti ti-send text-warning"></i> Resend Invite</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item d-flex align-items-center gap-2 text-danger" href="#"><i class="ti ti-trash"></i> Suspend Org</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
